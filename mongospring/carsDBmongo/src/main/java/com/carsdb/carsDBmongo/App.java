...
public class App implements CommandLineRunner
{
    ...
    public void run(String... arg0) throws Exception
    {
        ...
        openGraphData.setDescription(
                "The objective is always to outdo oneself. Pure beauty in all shapes and surfaces - this is the philosophy behind Horacio Pagani's latest creation. From this foundation is built a masterpiece with a perfect balance of attention to detail and technological advancement.");
        openGraphData.setImage(
                "https://dariofl24.github.io/mysupercars/cars_images/Pagani-Huayra%20Roadster-2017/details/social.jpg");
