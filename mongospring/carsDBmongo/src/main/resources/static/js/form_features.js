var allFeatures = (function () {
    ...
    var fillForm = function () {
        ...
        if (jsonString) {
            ...
            obj.carrouselImages.forEach(function (item, index) {
                ...
                $("#carousel_image_img_" + (index + 1)).attr('src', item.src);
            ...
            obj.composedImageDto.forEach(function (item, index) {
                ...
                $("#gal_thumb_image_preview_" + (index + 1)).attr('src', item.thumbUrl);
    ...
    var bindEvents = function () {
        ...
        $("input.carousel_image").change(function () {
            ...
            if (url) {
                ...
                $("img#carousel_image_img_" + index).attr('src', url);

            } else {
                $("img#carousel_image_img_" + index).attr('src', '/images/default/image_not_available_300.jpg');
            }

        });

        $("body").on("change", ".gal_thumb_image_link", function () {
            ...
            if (url) {
                ...
                $("img#gal_thumb_image_preview_" + index).attr('src', url);

            } else {
                $("img#gal_thumb_image_preview_" + index).attr('src', '/images/default/image_not_available_300.jpg');
            }
        });
