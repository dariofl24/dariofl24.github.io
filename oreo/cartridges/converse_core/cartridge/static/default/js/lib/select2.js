...
S2.define('select2/dropdown/attachBody',[
  ...
  AttachBody.prototype._positionDropdown = function () {
    ...
    var container = {
      height: this.$container.outerHeight(false) - 55
    };
    ...
    if (window.width > 1240) {
        if (!enoughRoomBelow || newDirection == 'above') {
           css.top = css.top + 40;
        }
        if (!enoughRoomAbove || newDirection == 'below') {
           css.top = css.top - 55;
        }
    }

    if (window.width < 1241 && window.width > 954 ) {
        if (newDirection == 'above') {
            css.top = css.top + 40;
        }
