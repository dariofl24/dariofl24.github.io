...
opts = Trollop::options do
   	opt :local_file, "Local directory to be uploaded", :type=>String, :required=>true
   	opt :relative_remote_file, "Remote file path relative to the remove <HOST>/ path. E.g.: /on/demandware.servlet/webdav/Sites/Libraries/ConverseSharedLibrary/fr/images/", :type=>String, :required=>true
...
remote_url = construct_url(opts.host, "#{opts.relative_remote_file}")
uploader = Demandware::Uploader.new(opts)
uploader.upload_file(opts.local_file, remote_url)
