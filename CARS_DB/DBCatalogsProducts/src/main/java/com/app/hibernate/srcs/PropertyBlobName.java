...
/**
 * PropertyBlobName generated by hbm2java
 */
public class PropertyBlobName  implements java.io.Serializable {
    ...
    public PropertyBlobName(String name, boolean multyval, boolean lov) {
        this.name = name;
        this.multyval = multyval;
        this.lov = lov;
    }
    public PropertyBlobName(String name, String description, byte[] defaultValue, Integer defaultValueLov, boolean multyval, boolean lov, Boolean indexable) {
       this.name = name;
