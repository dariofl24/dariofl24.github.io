...
/**
 * PropertyVarchar256Name generated by hbm2java
 */
public class PropertyVarchar256Name  implements java.io.Serializable {
    ...
    public PropertyVarchar256Name() {
    }

	
    public PropertyVarchar256Name(String name, boolean multyval, boolean lov) {
        this.name = name;
        this.multyval = multyval;
        this.lov = lov;
    }
    public PropertyVarchar256Name(String name, String description, String defaultValue, Integer defaultValueLov, boolean multyval, boolean lov, Boolean indexable) {
       this.name = name;
