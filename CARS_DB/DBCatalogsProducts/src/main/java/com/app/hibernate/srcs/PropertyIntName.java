...
/**
 * PropertyIntName generated by hbm2java
 */
public class PropertyIntName  implements java.io.Serializable {
    ...
    public PropertyIntName() {
    }

	
    public PropertyIntName(String name, boolean multyval, boolean lov) {
        this.name = name;
        this.multyval = multyval;
        this.lov = lov;
    }
    public PropertyIntName(String name, String description, Integer defaultValue, Integer defaultValueLov, boolean multyval, boolean lov, Boolean indexable) {
       this.name = name;
